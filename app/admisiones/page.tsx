...
export const metadata: Metadata = {
  title: "Admisiones",
  description: "Proceso de admisión, requisitos y becas del Colegio Pedro de Gante en Tulancingo. Inscripciones abiertas para preescolar, primaria, secundaria y preparatoria.",
};

const pasos = [
  { n: 1, t: "Solicita informes", d: "Escríbenos por WhatsApp o llámanos y agenda una visita guiada." },
  { n: 2, t: "Visita el colegio", d: "Conoce las instalaciones y resuelve tus dudas con el equipo de admisiones." },
  { n: 3, t: "Entrega de documentos", d: "Reúnes la documentación requerida para tu nivel de interés." },
  { n: 4, t: "¡Bienvenido a PdG!", d: "Inscripción, asignación de grupo y bienvenida a la comunidad." },
];
...
export default function Admisiones() {
  return (
    <main>
      <PageHero kicker="Admisiones 2026–2027" title={<>Pase directo a las <span className="grad-text">mejores universidades</span></>}
        sub="Inscripciones abiertas en los cuatro niveles. Asegura el lugar de tu hijo: el cupo por grupo es limitado." />
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {pasos.map((p) => (
              <div key={p.n} className="rounded-xl2 border border-line bg-white p-7">
                <div className="mb-4 grid h-11 w-11 place-items-center rounded-xl bg-gradient-to-br from-gold to-[#b1873b] font-display text-lg font-bold text-wine-2">{p.n}</div>
                <h4 className="font-display text-[17px] font-semibold text-wine">{p.t}</h4>
      ...
      <section className="bg-bg-2 py-20 md:py-24">
        <div className="wrap grid gap-12 md:grid-cols-2">
          ...
          <div>
            <SectionHead kicker="Apoyos" title="Becas y planes de pago" />
            <div className="rounded-xl2 border border-line bg-white p-8">
              <p className="text-[15.5px] text-muted">Contamos con apoyos y becas sujetas a evaluación y disponibilidad, así como planes de pago accesibles para las familias.</p>
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                <div className="rounded-xl bg-bg-2 p-5 text-center"><div className="font-display text-2xl font-bold text-wine">Becas</div><div className="mt-1 text-[13px] text-muted">académicas y de continuidad</div></div>
                <div className="rounded-xl bg-bg-2 p-5 text-center"><div className="font-display text-2xl font-bold text-wine">Planes</div><div className="mt-1 text-[13px] text-muted">de pago accesibles</div></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20">
        <div className="wrap">
          <div className="relative overflow-hidden rounded-[28px] bg-gradient-to-br from-wine to-wine-2 px-8 py-16 text-center">
            ...
            <p className="relative mx-auto mt-3.5 max-w-xl text-[17px] text-[#e7d6cf]">Cupo limitado por grupo. Solicita informes y agenda tu visita guiada.</p>
