...
export const metadata: Metadata = {
  ...
  description: "Aviso de Privacidad del Colegio Pedro de Gante conforme a la Ley Federal de Protección de Datos Personales en Posesión de los Particulares.",
  robots: { index: true, follow: false },
};

function Block({ title, children }: { title: string; children: React.ReactNode }) {
  return (<div className="mb-7"><h2 className="mb-2 font-display text-xl font-semibold text-wine">{title}</h2><div className="space-y-2 text-[15px] leading-relaxed text-muted">{children}</div></div>);
}
    ...
    <main>
      ...
      <section className="py-16 md:py-20">
        <div className="wrap max-w-3xl">
          <p className="mb-8 text-[15px] leading-relaxed text-muted">El <strong className="text-wine">Colegio Pedro de Gante</strong> es responsable del tratamiento de sus datos personales conforme a la <strong className="text-wine">Ley Federal de Protección de Datos Personales en Posesión de los Particulares</strong>.</p>
